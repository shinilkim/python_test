...
class Crawler2:
  def page1(self, url, no, wr_id):
    ...
    hdr = {'User-Agent':'Mozilla/5.0', 'referer':'https://avnana.com/bbs/board.php?bo_table=dt01&wr_id=18'}
  ...
  def download_test(self):
    start_time = time.time()
    cnt = 0
    for no in range(18, 1381):
      wr_id = str(no)
      if no != 0:
        cnt = cnt + 1
        url = "https://avnana.com/bbs/board.php?bo_table=dt01&wr_id="+wr_id
